import TableRepairInfrastructuresRequestsAdmin from "../components/TableRepairInfrastructuresRequestsAdmin";
...
const TableRepairInfrastructuresRequestsLayoutAdmin = () => {
  ...
  return (
    <>
      <Box class="boxInfra">
        <NavBar />
        <BreadcrumbsAdminThreeLayers breadcrumb1="Página principal" breadcrumb2="Solicitudes" breadcrumb3= "Solicitudes de Arreglo de Infraestructura"/>
        <br />
        <br />
        <Box
        ...
        >
          ...
          <TableRepairInfrastructuresRequestsAdmin
            reports={reports}
            gyms={gyms}
            users={users}
          />
...
export default TableRepairInfrastructuresRequestsLayoutAdmin;
