import TableMaintenanceRequestsAdmin from "../components/TableMaintenanceRequestsAdmin";
...
const TableMaintenanceRequestsLayoutAdmin = () => {
  ...
  return (
    <>
      <Box class="boxMach">
      <NavBar />
      <BreadcrumbsAdminThreeLayers breadcrumb1="Página principal" breadcrumb2="Solicitudes" breadcrumb3= "Solicitudes de Arreglo de Máquinas de Gimnasio"/>
        <br />
        <br />
        <Box 
...
export default TableMaintenanceRequestsLayoutAdmin;
